...
public class FeedReader.OwncloudNewsUtils : GLib.Object {
	...
	public OwncloudNewsUtils(GLib.SettingsBackend? settings_backend, Secret.Collection secrets)
	{
		...
		{
			m_settings = new GLib.Settings.with_backend("com.github.suzie97.communique.owncloud", settings_backend);
		}
		else
		{
			m_settings = new GLib.Settings("com.github.suzie97.communique.owncloud");
		}
