...
public class FeedReader.ArticleView : Gtk.Overlay {
	...
	public ArticleView () {
		...
		crashLabel.get_style_context ().add_class (Granite.STYLE_CLASS_H2_LABEL);
		var crashIcon = new Gtk.Image.from_icon_name ("face-sad", Gtk.IconSize.BUTTON);
	...
	private bool enterFullscreenVideo ()
	{
		...
		MainWindow.get_default ().hide_header ();
