...
public class FeedReader.CategoryRow : Gtk.ListBoxRow {
	...
	private bool onClick (Gdk.EventButton event)
	{
		...
		var remove_menuitem = new Gtk.MenuItem.with_label (_("Remove"));
		...
		// }
		// var rename_menuitem = new GLib.SimpleAction ("renameCat", null);
		...
		// app.add_action (rename_menuitem);
		...
		menu.append (remove_menuitem);
		menu.append (remove_with_feeds_menuitem);
